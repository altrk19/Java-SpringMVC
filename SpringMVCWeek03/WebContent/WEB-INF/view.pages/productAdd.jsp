...
2)commandname ile modelAttribute aynıdır. command eskimiştir.
3) path bilgisi classlarda instance variable isimleriyle aynı olmak zorunda. sınıf degiskeni ile yani.
-->
			...
			<fieldset>
				...
				<div class="form-group">
					...
					<div class="col-lg-10">				
						...
						<!-- böyle yazarsak hard coded yazmıs oluruz.dinamik yazmalıyız. bunun için aşağıdaki tek satırlık kodu ekledik. -->						
