<!-- projemizdeki js ve css gibi dosyaları sayfamıza eklemek için birkaç tane yöntemimiz var.
	burada   taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"   kullanarak 
	
	<link rel="stylesheet" ... .
	<link rel="stylesheet" ...
	
	şeklinde gosterim olabilir.
-->
...
<!-- burada kullanılacak degiskenler tanımlandı -->
...
function prepareMatrix(){
	...
	var url= '${matrixUrl}/brands='+selectedBrands;                     //link burda veriliyor. satır 18. 
