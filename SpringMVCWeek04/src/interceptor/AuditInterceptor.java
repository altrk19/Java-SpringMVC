//dil destegi için bu sýnýf kullanýlmadý. bu sýnýfý log4j için olusturduk.
//dil destegi için ilgili bean tanýmlamasýný yaptýk
...
public class AuditInterceptor extends HandlerInterceptorAdapter{
	...
	@Override
	//preHandle istek gelmeden önce çalýþýyor.
	...
	@Override
	//postHandle istek karsýlandýktan sonra çalýsýyor.
